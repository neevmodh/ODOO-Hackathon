...
🧪 Demo Accounts
(You may simulate session login with ID = 1 as done in index.php if not using full auth system yet.)
...
✅ Live tag filter system (via badge clicks)

✅ Upvote/Downvote toggle and tracking

✅ Snowfall animation across all pages

✅ Page transitions and styling polish
...
📊 Reputation score based on votes

📁 User profile with contributions
...
Open Source Icons & Emojis

🧾 License
This project is intended for educational and hackathon use only. Modify freely for learning or extension purposes.
